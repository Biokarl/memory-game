...
## Демо сайта можно посмотреть тут:

https://biokarl.github.io/memory-game/

## Функционал:
Игрок открывает две карточки за раз.\
Если карточки идентичны — они остаются
открытыми, если нет — закрываются через
короткую паузу.\
